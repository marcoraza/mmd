...
export const Icons: Record<IconKey, ReactElement> = {
  ...
  rfid: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path
        d="M3 11 A6 6 0 0 1 9 5 A6 6 0 0 1 15 11"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M5.5 11 A3.5 3.5 0 0 1 9 7.5 A3.5 3.5 0 0 1 12.5 11"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
  ...
  box: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path
        d="M9 1L16.5 5v8L9 17 1.5 13V5L9 1z"
        stroke="currentColor"
        strokeWidth="1.3"
  ...
  calendar: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      />
      <path
        d="M1.5 6h11M4.5 1.5v3M9.5 1.5v3"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
  ...
  package: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M2 4.5L8 1.5l6 3v7L8 14.5l-6-3v-7z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
  ...
  event_corporate: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <path
        d="M5 6h1.5M9.5 6H11M5 9h1.5M9.5 9H11M7 14.5v-3h2v3"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
  ...
  cat_iluminacao: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M8 1.5v2M3 3l1.4 1.4M13 3l-1.4 1.4M2 7.5h2M12 7.5h2"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
  ...
  cat_audio: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M7.5 2.5L4 5.5H1.5v5H4l3.5 3v-11z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
  ...
  cat_energia: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M9 1.5L3 9h4l-1 5.5L12 7H8l1-5.5z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
  ...
  cat_cabo: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M2 12c2 0 2-8 4-8s2 8 4 8 2-8 4-8"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
        fill="none"
  ...
  star: (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
      <path
        d="M6 1l1.55 3.15L11 4.65l-2.5 2.43.6 3.45L6 8.9 2.9 10.53l.6-3.45L1 4.65l3.45-.5L6 1z"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinejoin="round"
        fill="none"
  ...
  sort: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path
        d="M4 2v10M4 2l-2 2M4 2l2 2M10 12V2M10 12l-2-2M10 12l2-2"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  trash: (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
      <path
        d="M2 3.5h8M4.5 3V1.5h3V3M3 3.5l.5 7h5L9 3.5"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
