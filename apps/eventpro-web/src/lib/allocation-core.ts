// Core puro de alocação. As listas de seriais chegam prontas em memória.
// No legado a origem era a coluna `serial_numbers_designados uuid[]`; no EventPro
// a fonte é a tabela relacional `packing_allocations`. O shape em memória não muda.
...
export function serialAllocationState(
  status: StatusSerial,
