// Sobrescritível por env: o banco convergido do legado usa 'mmd-evento-comercial'
// (com os uploads históricos dentro); instalações novas usam o default.
export const EVENTO_COMERCIAL_BUCKET =
  process.env.EVENTPRO_COMERCIAL_BUCKET ?? 'eventpro-comercial'
...
export type ComercialValidationResult =
  { ok: true; data: NormalizedEventoComercial } | { ok: false; error: string }
