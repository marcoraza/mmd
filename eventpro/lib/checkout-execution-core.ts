// Core puro do plano de execução de check-out. Os seriais alocados por linha
// chegam prontos em memória (`seriais_alocados`). No legado a origem era a coluna
// `serial_numbers_designados uuid[]`; no EventPro a fonte é a tabela relacional
// `packing_allocations`. O shape em memória não muda.
